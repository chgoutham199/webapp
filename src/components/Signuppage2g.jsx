...
//                     </div>
//                     <div className="">
//                         <label htmlFor="username" className=" text-sm ml-0.5">Current Designtion<label className=' text-orange-500 text-sm' > *</label> </label>
//                         <div className=" flex flex-row">
...
//                     </div>
//                     <div className="">
//                         <label htmlFor="username" className=" text-sm ml-0.5">Current Company Name<label className=' text-orange-500 text-sm' > *</label> </label>
//                         <div className=" flex flex-row">
